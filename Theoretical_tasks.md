...
**3.Natural Language Processing (NLP) сервис:** для анализа и понимания входящего сообщения пользователя. Было найдено 2 потенциально подходящих сервиса от Amazon: 
   ...
   + *Amazon Comprehend* – это сервис обработки естественного языка, в котором для поиска ценной информации и взаимосвязей в тексте применяются технологии машинного обучения. 
 
   + *Amazon Lex* - это полностью управляемый сервис искусственного интеллекта (ИИ) с расширенными моделями естественного языка для проектирования, встраивания, тестирования и развертывания речевых интерфейсов в приложениях.
...
Рефлизовать описанные выше компоненты можно и с помощью других облачных сервисов. Так, например, Microsoft Azure предоставляет официальное решение для создания и развёртывания простого ChatGPT UI (https://github.com/Azure/openai-at-scale).
